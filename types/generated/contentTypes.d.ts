...
export interface ApiCategoryBusinessCategoryBusiness
  extends Struct.CollectionTypeSchema {
  collectionName: 'category_businesses';
  info: {
    displayName: 'categoryBusiness';
    pluralName: 'category-businesses';
    singularName: 'category-business';
  };
  options: {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::category-business.category-business'
    > &
      Schema.Attribute.Private;
...
export interface ApiCommandeCommande extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    hasDeliveryFee: Schema.Attribute.Boolean;
    ligneDeCommande: Schema.Attribute.Relation<
      'oneToMany',
      'api::ligne-de-commande.ligne-de-commande'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    methodeDePayment: Schema.Attribute.Component<
      'shared.methode-de-payment',
      true
    >;
    nom: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'nom'>;
    statusCommande: Schema.Attribute.Enumeration<
      [
        'new',
        'pending',
        'preparation',
    ...
    > &
      Schema.Attribute.DefaultTo<'sur_place'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiConfigurationConfiguration
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    fondImage: Schema.Attribute.Media<'images' | 'files'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    bgpattern: Schema.Attribute.Media<'images' | 'files'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    fondImage: Schema.Attribute.Media<'images' | 'files'>;
    illustration_livraison: Schema.Attribute.Media<'images' | 'files'>;
    illustration_sur_place: Schema.Attribute.Media<'images' | 'files'>;
    ImagesEnAvantProduit: Schema.Attribute.Media<'images' | 'files', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::global.global'
...
export interface ApiLigneDeCommandeLigneDeCommande
  extends Struct.CollectionTypeSchema {
  collectionName: 'ligne_de_commandes';
  info: {
    displayName: 'ligneDeCommande';
...
export interface ApiProduitProduit extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    imagePrincipale: Schema.Attribute.Media<'files' | 'images'>;
    imagesSecondaire: Schema.Attribute.Media<'images' | 'files', true>;
    isStock: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    ligne_de_commandes: Schema.Attribute.Relation<
      'oneToMany',
      'api::ligne-de-commande.ligne-de-commande'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    Nom: Schema.Attribute.String;
    prix: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<1>;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'Nom'>;
    stock: Schema.Attribute.Integer;
    tempsPreparation: Schema.Attribute.String;
    tenant: Schema.Attribute.Relation<'manyToOne', 'api::tenant.tenant'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiTableTable extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    bgTable: Schema.Attribute.String;
    chairs: Schema.Attribute.JSON;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    shape: Schema.Attribute.Enumeration<['rectangle', 'circle']>;
    statusTable: Schema.Attribute.String;
    tenant: Schema.Attribute.Relation<'manyToOne', 'api::tenant.tenant'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiTenantTenant extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    categories: Schema.Attribute.Relation<
      ...
      'api::category.category'
    >;
    category_business: Schema.Attribute.Relation<
      'manyToOne',
      'api::category-business.category-business'
    >;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::category-business.category-business': ApiCategoryBusinessCategoryBusiness;
      'api::category.category': ApiCategoryCategory;
      'api::commande.commande': ApiCommandeCommande;
      'api::configuration.configuration': ApiConfigurationConfiguration;
      'api::global.global': ApiGlobalGlobal;
      'api::ligne-de-commande.ligne-de-commande': ApiLigneDeCommandeLigneDeCommande;
